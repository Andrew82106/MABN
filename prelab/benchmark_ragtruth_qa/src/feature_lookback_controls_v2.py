...
ROOT = base.ROOT
OUT = ROOT / 'data/lookback_controls_v2'
PROTOCOL = ROOT / 'lookback_controls_protocol.json'
VERSION = 'qa-lookback-definition-controls-v2-report-json-only'
...
def prepare():
    ...
    report = {'ready': True, 'records': 793, 'partitions': {'fit': 634, 'calibration': 159},
        ...
        'header_token_id_sequences': [list(x) for x in sorted(set(tuple(x['header_token_ids']) for x in layouts))],
