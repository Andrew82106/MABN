...
ROOT = original.ROOT
DATA = ROOT / 'data/lookback_controls_v2'
OUT = ROOT / 'results/lookback_controls_v2'
OLD = ROOT / 'results/development_v1'
PROTOCOL = ROOT / 'lookback_controls_scoring_protocol_v2.json'
...
def cfg():
    ...
    return {'version': 'qa-lookback-definition-scoring-v2-report-json-fix',
