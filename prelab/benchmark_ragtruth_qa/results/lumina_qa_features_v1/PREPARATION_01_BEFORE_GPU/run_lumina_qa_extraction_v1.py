...
def signature(rows):
    ...
    return {'version': VERSION, **shared, 'code_sha256': code,
        ...
        'model_asset_verification': 'Reuse prior full-file SHA identities and download manifest; verify sizes now. Existing load_nf4 revalidates actual assets before explicit GPU load.',
