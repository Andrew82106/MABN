...
OUT=HERE/'llama_features_v1';PLANS=HERE/'data/new_token_plans.jsonl'
VERSION='qa-expanded-fit-uniform-llama-replay-v1';EXPECTED=3046
...
def cpu_check():
    ...
    for name,conf,klass in [('llama',LlamaConfig,LlamaForCausalLM),('qwen2',Qwen2Config,Qwen2ForCausalLM)]:
        ...
        p={'partition':'fit','official_split':'train','original':view};lo={'prefix_context_token_positions':list(range(6)),'header_token_positions':[6,7]}
