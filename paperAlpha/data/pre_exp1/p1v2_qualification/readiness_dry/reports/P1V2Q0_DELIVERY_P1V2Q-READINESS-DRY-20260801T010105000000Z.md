...
- Historical Q0 run ID: `P1V2Q-READINESS-DRY-20260801T010105000000Z`
...
- request_count: 143
- model_output: 128
- model_output_rejected: 13
- model_call_failed: 2
- fake_provider_calls: 143
- real_model_calls: 0
...
- Implementation verification summary: `14 passed`.
