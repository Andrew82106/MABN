...
- Current Q0 run ID: `P1V2Q-READINESS-DRY-20260801T010106000000Z`
...
- request_count: 145
- model_output: 128
- model_output_rejected: 15
- model_call_failed: 2
- fake_provider_calls: 145
- real_model_calls: 0
...
- bad_json: model_output_rejected=1
- decision_mismatch: model_output_rejected=1
- duplicate_key: model_output_rejected=1
- empty_output: model_output_rejected=1
- episode_mismatch: model_output_rejected=1
- extra_internal_field: model_output_rejected=1
- infinity_value: model_output_rejected=1
- missing_public_field: model_output_rejected=1
- nan_value: model_output_rejected=1
- nested_extra_field: model_output_rejected=1
- provider_exception: model_call_failed=1
- provider_timeout: model_call_failed=1
- role_mismatch: model_output_rejected=1
- valid_reject: model_output_rejected=1
- wrong_episode_valid_reject: model_output_rejected=1
- wrong_public_value: model_output_rejected=1
- wrong_role_valid_reject: model_output_rejected=1
